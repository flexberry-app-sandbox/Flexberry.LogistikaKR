...
namespace IIS.LogistikaKR
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.LogistikaKR.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.LogistikaKR.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.LogistikaKR.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.LogistikaKR.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.LogistikaKR.Товары));
                }
            }
        }
    }
