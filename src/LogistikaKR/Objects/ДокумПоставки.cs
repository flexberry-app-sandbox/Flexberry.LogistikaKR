...
namespace IIS.LogistikaKR
{
    ...
    public class ДокумПоставки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.LogistikaKR.Клиенты fКлиенты;
        
        private IIS.LogistikaKR.Организация fОрганизация;
        
        private IIS.LogistikaKR.Сотрудники fСотрудники;
        
        private IIS.LogistikaKR.DetailArrayOfИнфОЗаказе fИнфОЗаказе;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.LogistikaKR.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.LogistikaKR.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.LogistikaKR.Организация Организация
        {
            get
            {
                ...
                IIS.LogistikaKR.Организация result = this.fОрганизация;
        ...
        public virtual IIS.LogistikaKR.DetailArrayOfИнфОЗаказе ИнфОЗаказе
        {
            get
            {
                ...
                {
                    this.fИнфОЗаказе = new IIS.LogistikaKR.DetailArrayOfИнфОЗаказе(this);
                }
                IIS.LogistikaKR.DetailArrayOfИнфОЗаказе result = this.fИнфОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиE", typeof(IIS.LogistikaKR.ДокумПоставки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиL", typeof(IIS.LogistikaKR.ДокумПоставки));
                }
            }
        }
    }
