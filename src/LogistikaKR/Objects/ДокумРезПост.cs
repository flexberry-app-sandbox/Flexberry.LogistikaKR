...
namespace IIS.LogistikaKR
{
    ...
    public class ДокумРезПост : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.LogistikaKR.СостоянЗаказа fСтатусЗаказа;
        
        private bool fНаличиеДеф;
        
        private IIS.LogistikaKR.УдКл fУдовлКл;
        
        private IIS.LogistikaKR.ДокумРасп fДокумРасп;
        ...
        public virtual IIS.LogistikaKR.СостоянЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.LogistikaKR.СостоянЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.LogistikaKR.УдКл УдовлКл
        {
            get
            {
                ...
                IIS.LogistikaKR.УдКл result = this.fУдовлКл;
        ...
        [PropertyStorage(new string[] {
                "ДокумРасп"})]
        [NotNull()]
        public virtual IIS.LogistikaKR.ДокумРасп ДокумРасп
        {
            get
            {
                ...
                IIS.LogistikaKR.ДокумРасп result = this.fДокумРасп;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумРезПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезПостE", typeof(IIS.LogistikaKR.ДокумРезПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумРезПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезПостL", typeof(IIS.LogistikaKR.ДокумРезПост));
                }
            }
        }
    }
